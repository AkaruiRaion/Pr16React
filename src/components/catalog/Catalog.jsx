            ...
            <div className={s.sort__category}>
                <div className={s.cat}>
                    ...
                    <div className={s.btns}>
                        ...
                        <buttton onClick={() => setCategory(1)} className='btn'>Первая категория</buttton>
                        <buttton onClick={() => setCategory(2)} className='btn'>Вторая категория</buttton>
                        <buttton onClick={() => setCategory(3)} className='btn'>Третья категория</buttton>
                    </div>
                </div>
